<x-app-layout>
    ...
    <div class="container mt-4">
        <form action="{{ route('adminbarang.barangkeluar.update', $barangkeluar->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <a href="{{ route('adminbarang.barangkeluar.index') }}" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
</x-app-layout>
