<x-app-layout>
    <x-slot name="header">
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <a href="{{ route('adminbarang.satuan.create') }}" 
                        ...
                        <table class="min-w-full bg-white border border-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-300">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $satuan->nama_satuan }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2 flex">
                                        <a href="{{ route('adminbarang.satuan.edit', $satuan->id) }}" 
                                           class="text-purple-600 hover:text-purple-900">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                            </svg>
                                        </a>
                                        <form action="{{ route('adminbarang.satuan.destroy', $satuan->id) }}" 
                                              method="POST" 
                                              class="inline"
